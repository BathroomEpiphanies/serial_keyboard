...
SRC =	main.c lib/usb_keyboard_debug.c lib/print.c
...
CDEFS = -DF_CPU=$(F_CPU)UL \
        -DBOOTLOADER_JUMP=$(B_LOADER) \
        -DKEYBOARD_LAYOUT=$(LAYOUT) \
        -DKEYBOARD_MODEL_FILE=\"models/$(MODEL).h\" \
        -DSTR_MANUFACTURER=$(STR_MANUFACTURER) \
        -DSTR_PRODUCT=$(STR_PRODUCT) \
